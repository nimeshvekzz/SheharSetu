...
public class MainActivity extends AppCompatActivity {
    ...
    private void bindHeader() {
        ...
        // Notification Icon (Standard IDs: topImage)
        ImageView btnNotification = findViewById(R.id.topImage);
        if (btnNotification != null) {
            btnNotification.setOnClickListener(v ->
                    startActivity(new Intent(MainActivity.this, NotificationsActivity.class)));
        }

        // Profile Icon (Standard ID: headerOverlay)
        ImageView btnProfile = findViewById(R.id.headerOverlay);
        if (btnProfile != null) {
    ...
    private void setupAppDrawer() {
        ...
        // Default tinting handled by activity_main.xml (app:itemIconTint)
